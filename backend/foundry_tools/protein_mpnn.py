...
async def run_protein_mpnn(
    *,
    ...
    return await run_mpnn_design(
        ...
        work_dir=work_dir,
        input_dir=input_dir,
        out_dir_name="protein_mpnn_outputs",
        model_type="protein_mpnn",
        checkpoint_env="FOUNDRYUI_PROTEIN_MPNN_CKPT",
        checkpoint_default="models/proteinmpnn_v_48_020.pt",
